            ...
            monaco.languages.setMonarchTokensProvider('epilespylang', {
                tokenizer: {
                    root: [
                        ...
                        // Built-in functions
                        [/\b(print|input|len|num|str|push|pop|type|window|gameWindow3D|gameWindow2D|sleep|sin|cos|tan|asin|acos|atan|atan2|sinh|cosh|tanh|sqrt|cbrt|pow|exp|log|log10|log2|abs|ceil|floor|round|min|max|deg2rad|rad2deg|epilepsy|fetch|sound|beep|readFile|writeFile|appendFile|exists)\b/, 'keyword.function'],
